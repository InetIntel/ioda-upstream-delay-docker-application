"""The measurement loop - running every 30 minute mark"""
...
def load_profiles(cfg):
    """Buckets every profile's targets by (protocol, port). A profile
    whose targets or probe rate don't validate is skipped with an error.
    """
    profiles = []
